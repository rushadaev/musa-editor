		...
		>
			<PopoverTrigger asChild>
				<button
					type="button"
					className={cn(
						"flex items-center gap-1.5 rounded-md bg-[#bb9af7] px-[0.12rem] py-[0.12rem] text-white",
				...
				>
					<div className="relative flex items-center gap-1.5 rounded-[0.6rem] bg-linear-270 from-[#7aa2f7] to-[#bb9af7] px-4 py-1 shadow-[0_1px_3px_0px_rgba(0,0,0,0.65)]">
						...
						<div className="absolute top-0 left-0 z-10 flex size-full items-center justify-center rounded-[0.6rem] bg-linear-to-t from-white/0 to-white/50">
							<div className="absolute top-[0.08rem] z-50 h-[calc(100%-2px)] w-[calc(100%-2px)] rounded-[0.6rem] bg-linear-270 from-[#7aa2f7] to-[#bb9af7]"></div>
						</div>
					</div>
				</button>
			</PopoverTrigger>
